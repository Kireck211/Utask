...
public class Commons {
	public static String USER 		= "root"; //aquí es el nombre del usuario
	public static String PASSWORD 	= "Miperita.211"; //aquí se pone el password
	...
	public static String DBNAME 	= "poo_iteso"; //aquí es el nombre de la base de datos
